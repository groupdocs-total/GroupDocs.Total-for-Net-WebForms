...
using GroupDocs.Total.WebForms.Products.Signature.Loader;
using GroupDocs.Total.WebForms.Products.Signature.Signer;
using GroupDocs.Total.WebForms.Products.Signature.Util.Directory;
...
namespace GroupDocs.Total.WebForms.Products.Signature.Controllers
{
    /// <summary>
    ...
    public class SignatureApiController : ApiController
    {
        ...
        public HttpResponseMessage SaveImage(SignaturePostedDataEntity postedData)
        {
            try
            {
                ...
                {
                    imageName = Path.GetFileName(Resources.GetFreeFileName(DirectoryUtils.GetDataDirectory().ImageDirectory.Path, imageName));
